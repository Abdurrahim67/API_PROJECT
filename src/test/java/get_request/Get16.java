...
public class Get16 extends DummyRestBaseUrl {
    /*
    ...
    */
    ...
    public void get16() {
        ...
        //2.yol -->Lambda
        int sum1 = salaries.stream().reduce(0, Integer::sum);
        System.out.println("sum1 = " + sum1);
        int sum2 = salaries.stream().reduce(Integer::sum).get();
        System.out.println("sum2 = " + sum2);
        int sum3 = salaries.stream().reduce(Math::addExact).get();
